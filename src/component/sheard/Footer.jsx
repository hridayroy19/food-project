...
const Footer = () => {
  return (
    <div>
      <footer className="footer xl:px-24 py-16 px-4 text-base-content">
        <aside>
          <img src="https://i.ibb.co/yQGXDnS/d791df8772bb48c765f076aaab5cfdc2-removebg-preview.png" className=" w-32" alt="" />
