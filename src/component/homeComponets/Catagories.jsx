        ...
        <div className='flex flex-col sm:flex-row flex-wrap gap-5 justify-around items-center mt-12 '>
            {
                categoryItems?.map((item, i) => (
                    <div key={i} className='shadow-lg border-2 rounded-md bg-white py-6 px-5 w-52 mx-auto text-center cursor-pointer hover:-translate-y-4 transition-all duration-300 z-10'>
