      ...
      <div className="max-w-screen-2xl container mx-auto xl:px-24  px-4 py-4">
        <div className="flex flex-col md:flex-row flex-wrap md:justify-between items-center space-y-3 mb-8">
          ...
          <div className="flex flex-row justify-start md:items-center md:gap-8 gap-4  flex-wrap">
            <button
              onClick={showAll}
              className={selectedCategory === "all" ? " underline text-green" : " font-semibold text-[16px] "}
            >
              All
            </button>
            <button
              onClick={() => filterItems("salad")}
              className={selectedCategory === "salad " ? " text-orange-400 underline" : " font-semibold text-[16px] "}
            >
              Salad
            </button>
            <button
        ...
        {/* product card */}
        <div className="grid md:grid-cols-2 xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 ">
