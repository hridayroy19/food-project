...
console.log(stat);
  ...
  return (
    <div>
        {/* navbar */}
        <DashboardNavbar/>
      <h1 className="text-xl mb-10 text-orange-500 font-semibold">
        Overview
      </h1>
      <div>
        {/* ?stat use deisui */}
        <div className="stats bg-gray-300 shadow">
          <div className="stat place-items-center">
          <div className="stat-figure text-2xl text-secondary">
            <FaDollarSign/>
           </div>
            <div className="stat-title">Total Revenue</div>
            <div className="stat-value text-primary"> {stat?.totalRevenue} </div>
          ...
          <div className="stat-figure text-2xl text-secondary">
            ...
            <div className="stat-value text-[#3cbe97]">{stat?.payments}</div>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
            ...
            <div className="stat-value text-[#bf4aee]">{stat?.menuItems}</div>
            <div className="stat-desc">↘︎ 90 (14%)</div>
          </div>
        </div>
      </div>
